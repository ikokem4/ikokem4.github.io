...
### 1. AI 모델 다운로드
오픈소스 AI 모델을 다운받을 수 있습니다. Llama, Mistral, Stable Diffusion 등 유명한 모델들이 다 여기에 올라와 있습니다. [오픈소스 AI 모델이 왜 중요한지](/posts/2026-02-28-open-source-ai/)도 함께 읽어보시면 좋습니다.
...
### 4. 모델 학습/배포
자신이 파인튜닝한 모델을 업로드하고 공유할 수 있습니다. API로 배포하는 것도 가능합니다. [파인튜닝이 뭔지](/posts/2026-02-19-fine-tuning-explained/)는 별도 글에서 자세히 다루고 있습니다.
...
Hugging Face는 AI에 관심 있는 사람이라면 꼭 알아야 할 플랫폼입니다. 직접 모델을 돌리지 않더라도, Spaces에서 다양한 AI를 체험해보는 것만으로도 재밌습니다. [로컬 LLM을 직접 실행하는 방법](/posts/2026-03-10-local-llm/)도 참고해보세요.
