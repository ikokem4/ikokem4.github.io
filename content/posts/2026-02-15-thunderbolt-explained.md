...
### 3. 외장 GPU (eGPU)
썬더볼트는 외장 GPU 케이스를 연결할 수 있습니다. 노트북에 데스크탑급 GPU를 붙여서 쓸 수 있다는 뜻입니다. [eGPU 가이드](/posts/2026-03-16-egpu-guide/)에서 외장 GPU를 실제로 활용하는 방법을 확인해보세요.
...
썬더볼트는 USB-C의 **상위 호환** 같은 존재입니다. 같은 모양이지만 할 수 있는 게 더 많습니다. [USB 타입별 차이](/posts/2026-03-06-usb-type-explained/)도 함께 읽으면 케이블 규격을 제대로 이해하는 데 도움이 됩니다.
