...
VRM(Voltage Regulator Module)은 CPU에 전력을 공급하는 부분입니다. VRM 페이즈 수가 많고 품질이 좋을수록 고성능 CPU를 안정적으로 돌릴 수 있어요.
...
이미 DDR4 메모리를 갖고 있다면 DDR4 보드를 고를 수도 있는데, 신규 조립이라면 DDR5로 가는 게 앞으로를 생각하면 나을 겁니다.
...
이것만 체크하면 메인보드 때문에 후회할 일은 거의 없을 겁니다.
