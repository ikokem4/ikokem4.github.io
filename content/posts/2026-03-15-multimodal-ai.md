...
### ChatGPT / Claude
이미지를 업로드해서 분석을 요청할 수 있습니다. 저도 코딩할 때 에러 스크린샷을 그대로 올려서 해결 방법을 찾곤 합니다.
...
멀티모달 AI는 어렵게 느껴질 수 있지만, 이미 우리가 쓰고 있는 기능입니다. ChatGPT에 사진 올려보기, 구글 렌즈로 검색하기 — 이런 것들이 다 멀티모달입니다.
